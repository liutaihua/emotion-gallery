...
APIKEY_DICT = {
    OPENID_DOUBAN : {
        ...
        "redirect_uri" : "http://vm:8989/connect/douban/callback",
    },
    OPENID_SINA : {
        "key" : "",
        "secret" : "",
...
#==============Local Dev:==============
db = web.database(dbn='mysql', db='b', user='root', passwd='', charset='utf8',use_unicode=0)
